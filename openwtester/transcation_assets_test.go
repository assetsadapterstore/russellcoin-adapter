...
func TestTransfer(t *testing.T) {
	...
	addrs := []string{
		"RCkj75CbudracwGL3L67xUyDKPVM7qXBSs",
		"RDQP26Vt91Db146aV4P95N57Z7AWahMZYg",
		"RGjGmdC8GCje9uU48G57KJVouxYZN6rFYi",
		"RGm4uVo9zAf92TJKUXQrFNNt8wna7MK2MH",
		"RKR32HmqLHybJQvkt6ZKTDTGqvyVHp2CoV",
		"RUo3bTEYyQAknuJYqaSDMd12W5Y5vn3E33",
	}
...
func TestSummary(t *testing.T) {
	tm := testInitWalletManager()
	walletID := "WNa4uEowi9ZmP8KbcdLAEaQyXKBZjpow3n"
	accountID := "9icsntbuANDSnVjzfcnef1Us2Yw3VVs9G4ABvmYdnbRa"
	summaryAddress := "RAAqcjQwKFuvworExSDu69vQ26gx5YNFuL"
